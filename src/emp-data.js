  ...
  render() {
    return html`
      ...
      <thead>
        ...
        ${repeat(this.filteredformData,(item) => html`
            <tr>
              <td>${item.fullName}</td>
              ...
              <td>${item.zip}</td>
              <td id="btn">
                <button class="update" @click="${() => this.edit(item)}">Edit</button>
              
                <button class="delete" @click="${() => this.delete(item)}">Delete</button>
              </td>
            </tr>
            
            
            
            ${this.updateUser === item ? html`
        ...
        <form>
          ...
          <table>
            <tr>
              ...
              <td>
                  ...
                  <input type="text" .value="${item.fullName}" @input="${e => item.fullName = e.target.value}"><br />
              </td>
            ...
            <tr>
              ...
              <td>
              <input type="text" .value="${item.designation}" @input="${e => item.designation = e.target.value}">
              </td>
              ...
              <td>
              <input type="text" .value="${item.department}" @input="${e => item.department = e.target.value}">
              </td>
            </tr>
            <tr>
              <td>
          ...
          <button class="btn"  @click="${() => this.saveUser(item)}">Save</button>
          <button class="btn" @click="${() => this.cancelEdit()}" id= "cancel" >Cancel</button>
